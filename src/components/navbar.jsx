...
import { Instagram, ShoppingBag, Search, Menu, X, ChevronDown, User } from "lucide-react"
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            <a href="/"><img src={logo} className="h-12 w-12" alt="Logo"></img></a>
        ...
        <div className="fixed inset-0 bg-white z-40 md:hidden overflow-y-auto">
          <div className="p-4">
            ...
            <div className="flex justify-between items-center mb-6">
              <a href="/"><img src={logo} className="h-8 w-8" alt="Logo"></img></a>
              <button onClick={toggleMobileMenu} className="focus:outline-none">
                <X className="w-6 h-6" />
              </button>
            </div>
